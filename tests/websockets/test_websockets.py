...
# TODO: create test for correct order status of received messages
# TODO: organize tests with classes like http


@pytest.mark.asyncio
async def test_client_gets_status_update_messages(websocket_client):
    # given
...
@pytest.mark.asyncio
async def test_multiple_clients_get_broadcast_messages(websocket_client,
...
@pytest.mark.asyncio
async def test_no_more_messages_are_received_after_cancelled_status(websocket_client,
                                                                    second_websocket_client,
                                                                    third_websocket_client):
    # given
